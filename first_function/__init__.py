    ...
    for _ in range(repetition_num):
        ...
        if items_by_index:
            ...
            for i in range(max_iter_num):
                ...
                if(problem.start_position[0] >= max_x-0.1):
                    problem.start_position = 0.3, problem.start_position[1] + 0.3
                else:
                    problem.start_position = problem.start_position[0] + 0.39, problem.start_position[1]
...
def create_problems(dot_coordinates):
    ...
    items = [Item(Polygon([(0., 0.), (1., 0.), (1., 1.75), (0., 1.75)]), 1., 1.),
             Item(Polygon([(0., 0.), (1., 0.), (1., 1.75), (0., 1.75)]), 1., 1.),
             Item(Polygon([(0., 0.), (1., 0.), (1., 1.75), (0., 1.75)]), 1., 1.),
             Item(Polygon([(0., 0.), (1., 0.), (1., 1.75), (0., 1.75)]), 1., 1.),
             Item(Polygon([(0., 0.), (1., 0.), (1., 1.75), (0., 1.75)]), 1., 1.),
             Item(Polygon([(0., 0.), (1., 0.), (1., 1.75), (0., 1.75)]), 1., 1.),
...
def main(request: func.HttpRequest):
    ...
    try:
        ...
        for i in range(1, 1000):  # Set an upper limit for the number of coordinates
            x_key = f'calcPos{i}_x'
            y_key = f'calcPos{i}_y'
